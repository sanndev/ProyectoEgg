...
async function cargarMascotas(offset,limit){
  ...
  for(let mascota of mascotas){
    ...
    if(i >= offset && i<=limit){
        ...
        boton1.setAttribute("onclick",'pepe(' + mascota.id + ')') //cambiar por el metodo de consulta
...
async function CargarMascota(id){
    ...
    const requestMascota = await fetch('mascota/mostrarmascotasid?id='+ id +'', {
      method: 'GET',
      headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
    ...
    console.log("---------------------------------------------------------------")
     ...
     console.log(mascota.tipoAnimal)
     console.log(mascota.sexo)
     console.log(mascota.tamanioMascota)
     console.log(mascota.usuario)
...
async function CargarUnaMascota(id){
    ...
    showModal(mascota.nombre,mascota.edadMascota,mascota.tipoAnimal,mascota.sexo,mascota.tamanioMascota,mascota.usuario,mascota.descripcion,mascota.foto) //modificar a la hora de agregar los datos de la mascota
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-flex w-100">
            ...
            <div class="container d-block">
              ...
              <div class="d-flex">
                <h4 class="me-3"><strong>Ubicacion:</strong> Tafi Viejo (Tucuman)</h4> //MODIFICAR CUANDO TRTAIGA USU
              </div>
